...
let verifyroless = message.guild.roles.find(`name`, "々 Astrayos Commanders");
if (!message.member.roles.find("name", "々 Astrayos Commanders")) {
return message.channel.send(`Bu Komutu Kullanmak için ** 々 Astrayos Commanders** Rolüne Sahip Olman Lazım ${emoji1}`)
}
